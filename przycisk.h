...
////JG:wlasna wersja jako kopia pomyslu MG
//class Guzik {
//public:
//	const char* text; // text, oczywiście
//	float posX, posY; // pozycja
//	int fontSize; // bazowy rozmiar czcionki 
//	bool selected; // czy zaznaczony?
//	bool center; // czy wyśrodkowany?
//	bool enabled; // czy jest enabled?
//	bool forceFitOnScreen; // czy cały przycisk ma być na ekranie? Rusza go jakby wyszedł za ekran.
...
//	// [&] {/* KOD */};
//	// Zobaczcie mainMenu.cpp aby dokładniej obczaić o co mi chodzi z tym
//	Guzik (const char* text, float posX, float posY, int fontSize, bool center = false, std::function<void()> onActivation = [&] {}, bool forceFit = false, Color colorActive = WHITE, Color colorInactive = BLACK) {
//		this->text = text;
//		this->posX = posX; this->posY = posY;
//		this->fontSize = fontSize;
//		this->center = center;
