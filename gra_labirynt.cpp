...
namespace labirynt {
	...
	void drawLabirynt() {
		...
		*/
		...
		DrawText(TextFormat("Rekord autora: %0.2lf", zmienne->rekord_swiata), szer - 258.0f * Skala_liter, 206.0f * Skala_liter, (int)(18.0f * Skala_liter), napis_epizodu);//JG:wyswietla najlepszy wynik dla tego poziomu na swiecie
		//JG: WYNIKI - KONIEC
