...
namespace menu {
	...
	_Przycisk* Buttons[] = {
		new PrzyciskTekst("Wybierz Poziom", {0.5, 0.3}, {0.2, 0.1}, [&] { {stanGry = StanEkranu::WYBOR_POZIOMU; }}),
		new PrzyciskTekst("Instrukcja",{0.5, 0.4}, {0.2, 0.1}, [&] { {stanGry = StanEkranu::INSTRUKCJA; }}),
		new PrzyciskTekst("Zmień Użytkownika", {0.5, 0.5}, {0.2, 0.1}, [&] { {stanGry = StanEkranu::WYBOR_UZYTKOWNIKA; }}),
		new PrzyciskTekst("Ustawienia", {0.5, 0.6}, {0.2, 0.1}, [&] {stanGry = StanEkranu::USTAWIENIA; ustawienia::initSettings(); }),
		new PrzyciskTekst("Twórcy", {0.5, 0.7}, {0.2, 0.1}, [&] {stanGry = StanEkranu::TWORCY; }),
		new PrzyciskTekst("Wyjdź", {0.5, 0.8}, {0.2, 0.1}, [&] {stanGry = StanEkranu::EXIT; }),
#ifndef _DEBUG // tego w Release nie będzie
